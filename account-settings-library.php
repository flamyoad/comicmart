...
$bookmarkList = Bookmark::getAll($_SESSION["user_id"]);
?>
...
<body>
    ...
    <div class="my-container">
        ...
        <div>
            ...
            <div class="content">
                <div class="topbar">
                    <a class="topbar-links active" href="account-settings-library.php">
                        <i class="fa fa-bookmark" style="margin-right: 5px;" aria-hidden="true"></i>
                        Bookmark
                    </a>

                    <a class="topbar-links" style="margin-left: 50px;" href="account-settings-readhistory.php">
                    ...
                    <?php foreach ($bookmarkList as $bookmark) :
                        ...
                        <li class="manga-item">
                            <a href="<?php echo $mangaLink ?>" target="_blank">
                                <img class="manga-cover" src="<?php echo $bookmark->getCoverImage() ?>">
                            </a>
